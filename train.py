...
def train_prediction_network(args):
    ...
    sys.stdout = Logger(os.path.join('log/', 'log_train.txt'))
    train_prediction(data_set, parents, bone_length, config)


def parse_args():
    parser = argparse.ArgumentParser("train")
    parser.add_argument("--train", type=str, default='prediction')
    parser.add_argument("--data_path", type=str, default='/home/lh/lihao/code/data/Cyprus_out')
